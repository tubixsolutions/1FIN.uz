...
const data = {
    ...
    ru: [{
        ...
        cardDesc2: "Наши специалисты имеют большой практический опыт работы в сфере бухгалтерского учета, а также опыт налогового консультирования . \n-Бухгалтерия \n-Оптимизация налогов \n-Восстановить учет \n-Аудит Оказываем такие услуги, как ведение бухгалтерии в программе 1с.",
