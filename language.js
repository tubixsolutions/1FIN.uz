...
const data = {
    ...
    ru: [{
        ...
        cardDesc1: "1FIN — одна из ведущих компаний в Узбекистане, специализирующаяся на предоставлении полного спектра бухгалтерских услуг, налоговых и юридических консультациях, финансовом консалтинге и аутсорсинге бизнес-процессов, а также предоставлении аудиторских услуг с августа 2024 года.",
        cardDesc2: "Наши специалисты имеют большой практический опыт работы в сфере бухгалтерского учета, а также опыт налогового консультирования . <br/> -Бухгалтерия <br/>-Оптимизация налогов <br/>-Восстановить учет <br/>-Аудит Оказываем такие услуги, как ведение бухгалтерии в программе 1с.",
        ...
        serviceDesc15: "Проведение аудита",
...
lang_form.addEventListener('change', (e) => {
    ...
    if (language === "uz") {
        ...
        lang_service15.innerHTML = data.uz[0].serviceDesc15
        ...
        lang_service15.innerHTML = data.ru[0].serviceDesc15
